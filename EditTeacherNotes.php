...
if (isset($_POST["MM_action"])) {
	...
	if ($_POST["MM_action"] == "Add") {
			$sqlCommand = sprintf("INSERT INTO ProjectDetails SET ProjectId = %s, Teacher = %s",
...
*/
  	...
  	$sqlCommand = sprintf("UPDATE ProjectDetails SET ProjectId=%s, Teacher=%s WHERE Id=%s",
                       GetSQLValueString($_POST['ProjectId'], "int"),
											 GetSQLValueString($_POST['Teacher'], "text"),
...
<div class="subNav"><a href="ViewProjects.php">View Projects</a> | <a href="ProjectDetails.php?Id=<?php echo $projectId; ?>">View Detail</a> | <a href="ProjectDetails.php?Id=<?php echo $projectId; ?>">View Project</a> | <a href="ViewSteps.php?ProjectId=<?php echo $projectId; ?>">View Steps</a> | <a href="EditStep.php?action=Add"><img src="_images/icons/Plus16x16.gif" height="16" width="16" /> Add Step</a> | <a href="EditMedia.php?action=Add"><img src="_images/icons/Plus16x16.gif" height="16" width="16" /> Add Media</a></div>
<div class="layer">
