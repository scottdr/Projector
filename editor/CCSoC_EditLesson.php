...
if (isset($_POST["MM_action"])) {
	...
	if ($_POST["MM_action"] == "Add") {
		$sqlCommand = sprintf("INSERT INTO Projects (Name, Duration, `Description`, Author, Status, Number) VALUES (%s, %s, %s, %s, %s, %s)",
	...
	$sqlCommand = sprintf("UPDATE Projects SET Name=%s, Duration=%s, Author=%s, `Description`=%s, Status=%s, Number=%s WHERE Id=%s",
                       GetSQLValueString($_POST['Name'], "text"),
                       GetSQLValueString($_POST['Duration'], "int"),
                       GetSQLValueString($_POST['Author'], "text"),
                       GetSQLValueString($_POST['Description'], "text"),
