  ...
  <!--<nav class="navbar" style="border:0; margin:0;">
    ...
    <h1 class="span6">
        <a href="<?php if (isset($GLOBALS['instance']) && $GLOBALS['instance'] == "ccsoc") echo "/editor/CC_CourseBrowser.php"; else echo "/Gallery.php"; ?>" style="font-size:22px; text-decoration:none;">
