                	...
                	<table cellpadding="5" width="100%">
                      ...
                      <tr>
                        ...
                        <td valign="top">
                            ...
                            <input name="ThumbNail" type="text" class="span9" id="ThumbNail" value="<?php echo $row_Resource['ImageThumbnail']; ?>">
                            <br/><br/>
                      ...
                      <tr>
                        ...
                        <td valign="top">
                            <a class="btn btn-small" href="#" onClick="addImage(this)"><i class="icon-arrow-up"></i> Add image</a>
                            <input name="DetailImage" type="text" class="span9" id="DetailImage" value="<?php echo $row_Resource['ImageLarge']; ?>">
                            <br/><br/>
