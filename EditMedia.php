...
<div class="subNav"><a href="ViewProjects.php">View Projects</a> | <a href="ProjectDetails.php?Id=<?php echo $projectId; ?>">View Detail</a> | <a href="ViewSteps.php?ProjectId=<?php echo $projectId; ?>">View Steps</a> | <a href="ViewMedia.php">View Media</a> | <a href="EditMedia.php?action=Add"><img src="_images/icons/Plus16x16.gif" height="16" width="16" /> Add Media</a><a href="EditVideo.php?action=Add"><img src="_images/icons/Plus16x16.gif" height="16" width="16" /> Add Video</a></div>
<div class="layer">
