...
<div class="subNav"><a href="ViewProjects.php">View Projects</a> | <a href="ProjectDetails.php?Id=<?php echo $row_foundRecord['Id']; ?>">View Project</a> | <a href="EditProject.php?action=Add"><img src="_images/icons/Plus16x16.gif" height="16" width="16" /> Add Project</a> | <a href="ViewRoutines.php">View Routines</a> | <a href="ViewTopics.php">Topics</a> |  <a href="ViewVideos.php">Videos</a></div>
<div class="layer">
	<form action="<?php echo $editFormAction; ?>" id="updateForm" name="updateForm" method="POST">
  <div class="subSubNav"><a href="EditDetails.php?ProjectId=<?php echo $row_foundRecord['Id']; ?>"><img src="_images/icons/Pencil26x26.gif" width="20" height="20" alt="Edit Details" /> Edit Details</a> | <a href="ViewSteps.php?ProjectId=<?php echo $row_foundRecord['Id']; ?>">View Steps</a> | <a href="EditStep.php?action=Add&ProjectId=<?php echo $row_foundRecord['Id']; ?>"><img src="_images/icons/Plus16x16.gif" height="16" width="16" /> Add Step</a> | <a href="ViewMedia.php?ProjectId=<?php echo $row_foundRecord['Id']; ?>">View Media</a> | <a href="EditMedia.php?action=Add&ProjectId=<?php echo $row_foundRecord['Id']; ?>"><img src="_images/icons/Plus16x16.gif" height="16" width="16" /> Add Media</a> | <a href="ViewSlides.php?ProjectId=<?php echo $row_foundRecord['Id']; ?>">Slides</a> | <a href="EditVideo.php?action=Add&ProjectId=<?php echo $row_foundRecord['Id']; ?>"><img src="_images/icons/Plus16x16.gif" height="16" width="16" /> Add Video</a></div>
  <fieldset>
